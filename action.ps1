        ...
        Process {
            ...
            for ($i = 0; $i -lt $Users.Count; $i++) {
                If ($Users[$i] -eq '--MyspaceTom--') {
                    ...
                    $null=$OutputMyTop8.AppendLine("<td style=''><p style='text-align:center'><a href='https://github.com/$($Users[$i])'><img style='display: block; margin-left: auto; margin-right: auto;' src='https://github.com/$($Users[$i]).png' alt='' width='$PixelLength' height='$PixelLength' /></a></p><p style='text-align: center;'>$($i + 1). <a href='https://github.com/$($Users[$i])'>$($Users[$i])</a></p></td>")
                }
                If ($i -eq 3) {
